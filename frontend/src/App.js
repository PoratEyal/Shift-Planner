        ...
        <React.Fragment>
            <Routes>
                ...
                <Route
                    ...
                    element={<ProtectedRoute component={ManagerHomePage} role="admin" />}
                ></Route>
                <Route
                    path="/createNewWeek"
                    element={<ProtectedRoute component={CreateWeek} role="admin" />}
                />
                <Route
                    path="/currentWeekShifts"
                    element={<ProtectedRoute component={CurrentWeekShifts} role="admin" />}
                />
                <Route
                    path="/SeeCurrentWeekShifts"
                    element={<ProtectedRoute component={SeeCurrentWeek} role="admin" />}
                />
                <Route
                    path="/managerSettings"
                    element={<ProtectedRoute component={ManagerSettings} role="admin" />}
                />
                <Route
                    path="/editCurrentWeek"
                    element={<ProtectedRoute component={EditCurrentWeek} role="admin" />}
                />
                <Route path="/roles" element={<ProtectedRoute component={Roles} role="admin" />} />
                <Route
                    path="/workers"
                    element={<ProtectedRoute component={Workers} role="admin" />}
                />
                <Route
                    path="/createWorker"
                    element={<ProtectedRoute component={CreateWorker} role="admin" />}
                />
                <Route
                    path="/defShifts"
                    element={<ProtectedRoute component={defShifts} role="admin" />}
                ></Route>
                <Route
                    path="/createShift"
                    element={<ProtectedRoute component={CreateShift} role="admin" />}
                ></Route>
                <Route
                    path="/settingsPage"
                    element={<ProtectedRoute component={SettingsPage} role="admin" />}
                ></Route>

                {/* - - - - - - - -workers - - - - - - -  */}
                <Route
                    path="/CurrentWeek"
                    element={<ProtectedRoute component={CurrentWeekUser} role="user" />}
                ></Route>
                <Route
                    path="/chooseShifts"
                    element={<ProtectedRoute component={ChooseShifts} role="user" />}
                ></Route>
                <Route
                    path="/userSettings"
                    element={<ProtectedRoute component={UserSetings} role="user" />}
                ></Route>
            </Routes>
        </React.Fragment>
    );
