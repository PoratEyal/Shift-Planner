...
import EditWorker from './components/manegerComponents/Workers/editWorker';
...
const App = () => {
  ...
  return <React.Fragment>
      <Routes>
        ...
        <Route path='/EditWorker' element={<ProtectedRoute component={EditWorker} role="admin"/>}></Route>
