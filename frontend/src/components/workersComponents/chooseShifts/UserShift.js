...
const UserShift = (props) => {
    ...
    const addWorkerToShift = () => {
        ...
        const updtaedShift = {
            ...props.shift,
            availableWorkers: [...shift.availableWorkers, data],
        };
        const reqBody = {
        ...
        axios
            .put(`${process.env.REACT_APP_URL}/addWorkerToAvial`, reqBody)
            .then((response) => {})
            .catch((error) => {
    ...
    const removeWorkerFromShift = () => {
        ...
        axios
            .put(`${process.env.REACT_APP_URL}/delWorkerToAvial`, reqBody)
            .then((response) => {})
            .catch((error) => {
                console.log(error.response.data.error);
            });
        if (shift.workers.includes(data._id)) {
            axios
                .put(`${process.env.REACT_APP_URL}/removeWorkerFromWorkrs`, reqBody)
                .then((response) => {
