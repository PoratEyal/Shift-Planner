...
const ShiftCurrentWeek = (props) => {
    ...
    const addWorkerShift = (workerId) => {
        ...
        axios
            .put(`${process.env.REACT_APP_URL}/addWorkerToWorkrs`, reqBody)
            .then((response) => {
    ...
    const addWorkerToStandBy = (workerId) => {
        ...
        axios
            .put(`${process.env.REACT_APP_URL}/addWorkerToStandBy`, reqBody)
            .then((response) => {
                props.setDay(response.data);
            })
            .catch((error) => {
    ...
    const delWorkerFromStandBy = (workerId) => {
        ...
        axios
            .put(`${process.env.REACT_APP_URL}/delWorkerFromSB`, reqBody)
            .then((response) => {
                props.setDay(response.data);
            })
            .catch((error) => {
    ...
    const removeWorkerShift = (workerId) => {
        ...
        axios
            .put(`${process.env.REACT_APP_URL}/WorkersToAvail`, reqBody)
            .then((response) => {
                props.setDay(response.data);
            })
            .catch((error) => {
            ...
            <div className={styles.shift}>
                <div>
                    <p className={styles.shift_description}>
                        {shift.description}&nbsp;: {moment(shift.endTime).format("HH:mm")} -{" "}
