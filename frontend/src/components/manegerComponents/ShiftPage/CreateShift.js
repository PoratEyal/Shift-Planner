...
const CreateShift = () => {
    ...
    return (
        <PageLayout text="יצירת משמרת קבועה">
            <div className={styles.container}>
                <form className={styles.userForm}>
                    <div>
                        <input
                            placeholder="שם משמרת"
                ...
                <div className={styles.btn_div}>
                    <button className={styles.btn} onClick={clickHandle}>
                        אישור
                    </button>
                    <button className={styles.btn_cancel} onClick={() => navigate("/defShifts")}>
                        ביטול
                    </button>
                </div>
